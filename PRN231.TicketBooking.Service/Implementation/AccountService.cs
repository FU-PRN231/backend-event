...
namespace PRN231.TicketBooking.Service.Implementation
{
    ...
    {
        private readonly Repository.Implementation.IRepository<Account> _accountRepository;
        ...
        public AccountService(Repository.Implementation.IRepository<Account> accountRepository,
        ...
        public async Task<AppActionResult> GetAccountByUserId(string id)
        {
            ...
            try
            {
                var userRoleRepository = Resolve<Repository.Implementation.IRepository<IdentityUserRole<string>>>();
                var roleRepository = Resolve<Repository.Implementation.IRepository<IdentityRole>>();
                ...
                if (!BuildAppActionResultIsError(result))
                    result.Result.Data = accountRoleResponse;
            }
            catch (Exception ex)
            {
                result = BuildAppActionResultError(result, ex.Message);
